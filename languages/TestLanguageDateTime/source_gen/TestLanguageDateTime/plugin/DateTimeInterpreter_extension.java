...
public class DateTimeInterpreter_extension extends Extension.Default<IInterpreter> {
  public DateTimeInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterDateTimeInterpreter();
  }
}
