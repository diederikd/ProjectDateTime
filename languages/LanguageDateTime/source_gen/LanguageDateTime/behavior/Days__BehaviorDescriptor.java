...
public final class Days__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xef5812095a6e41d4L, 0x8160c9506c67dfa5L, 0x6b28562f90555f6L, "LanguageDateTime.structure.Days");
  ...
  /*package*/ static void SetEditorContext_id7CcpcRWcvwj(@NotNull SNode __thisNode__, EditorComponent editorcomponent) {
    ...
    UpdaterListener listener = Days__BehaviorDescriptor.createListener_id7CcpcRWcAKM.invoke(__thisNode__, editorcomponent);
  ...
  /*package*/ static UpdaterListener createListener_id7CcpcRWcAKM(@NotNull SNode __thisNode__, final EditorComponent editorComponent) {
    ...
    return new UpdaterListener() {
      public void cellSynchronizedWithModel(EditorCell p0) {
        Days__BehaviorDescriptor.elementchanged_id6d4fgnE6Yj4.invoke(_this, editorComponent);
      }
  ...
  /*package*/ static void elementchanged_id6d4fgnE6Yj4(@NotNull SNode __thisNode__, EditorComponent editorComponent) {
    if ((SNodeOperations.getParent(__thisNode__) == null)) {
      Days__BehaviorDescriptor.removelistener_id6d4fgnE6YTb.invoke(__thisNode__, editorComponent);
    } else {
      Days__BehaviorDescriptor.grabtext_id6d4fgnE6YZh.invoke(__thisNode__, editorComponent);
    }
  }
  ...
  /*package*/ static void grabtext_id6d4fgnE6YZh(@NotNull SNode __thisNode__, EditorComponent editorComponent) {
    EditorCell cell = editorComponent.findNodeCell(__thisNode__);
    String text = cell.renderText().getText();
    String oldtext = SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xef5812095a6e41d4L, 0x8160c9506c67dfa5L, 0x6b28562f90555f6L, 0x7b09cf0db9d24511L, "text"));
    if (eq_m9jgh8_a0d0r(oldtext, text)) {
      return;
    }
    try {
      SPropertyOperations.set(__thisNode__, MetaAdapterFactory.getProperty(0xef5812095a6e41d4L, 0x8160c9506c67dfa5L, 0x6b28562f90555f6L, 0x7b09cf0db9d24511L, "text"), text);
      if (LOG.isInfoEnabled()) {
        LOG.info("" + text);
      }
    } catch (Throwable t) {
  ...
  protected static Logger LOG = LogManager.getLogger(Days__BehaviorDescriptor.class);
  private static boolean eq_m9jgh8_a0d0r(Object a, Object b) {
